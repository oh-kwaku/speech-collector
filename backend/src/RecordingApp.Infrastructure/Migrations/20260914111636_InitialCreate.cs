        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecordingSessions_Speakers_SpeakerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recordings_Photos_PhotoId",
                        column: x => x.PhotoId,
                        principalTable: "Photos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Recordings_RecordingSessions_SessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnnotatorUserId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recordings_PhotoId",
                table: "Recordings",
                column: "PhotoId");

            migrationBuilder.CreateIndex(
                name: "IX_Recordings_S3Key",
                table: "Recordings",
                column: "S3Key",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecordingSessions_SpeakerId",
